const en_US = {
  ...
  CONTROL_PANEL_FEATURES: `POINTS & OVERLAYS`,
  ...
  DIALOG_SHARE_TWITTER: `The neighborhoods you live in have a major impact on social mobility. Learn how the chances for upward mobility can be increased for all communities. `,
  ...
  DIALOG_SHARE_EMAIL_SUBJECT: `NTX Social Mobility Hub`,
  DIALOG_SHARE_EMAIL_BODY: `The neighborhoods you live in have a major impact on social mobility. Learn about the ways that knowledge about barriers and drivers to upward mobility can be put to action, and how the chances for upward mobility can be increased for all communities. `,
  ...
  MAP_FILTERS_SELECT_NONE: `No indicators are available for this geographical
  layer.`,
  ...
  UI_MAP_FEATURE_FEDCONGRESS: `Federal Congressional Districts`,
  UI_MAP_FEATURE_STATEHOUSE: `Texas State House Districts`,
  UI_MAP_FEATURE_STATESENATE: `Texas State Senate Districts`,
  UI_MAP_FEATURE_SCHOOLDISTRICTS: `Texas Independent School Districts`,
  ...
  UI_MAP_LAYER_STATIC_DESC: `<p>Toggle these layers on and off to see supplemental geographic boundaries.</p>`,
  UI_MAP_LAYERS_STATIC_TITLE: `Overlays`,
  ...
  TOUR_DESK_STEP_2: `In the map view, geographic regions are displayed and colored according to where they fall in the currently selected metric. When hovering, a window provides more information about regions as well as point features on the map.`,
  TOUR_MOBILE_STEP_2: `In the map view, geographic regions are displayed and colored according to where they fall in the currently selected metric.`,
  ...
  TOUR_DESK_STEP_5: `Use the Data Controls panel to select which geographic regions are displayed on the map, as well as the active metric.`,
  TOUR_DESK_STEP_6: `Use these buttons to switch between region types.`,
  ...
  TOUR_DESK_STEP_11: `The info panel contains additional information about using the interface.`,
  TOUR_DESK_STEP_12: `Use the "Tour" button to display this information again.`,
  TOUR_MOBILE_STEP_12: `Use the "Tour" button in the info panel to display this information again.`,
  ...
  FEEDBACK_INSTR: `<p>Use the form below to submit feedback about the map. If there's a location in your neighborhood that is no longer there, you want to tell us about something new, or correct inaccurate information, please reach out!</p><p>The "Use my current location" button will tie your feedback to your current location. You can also search for an address or point of interest.</p>`,
  ...
  FEEDBACK_BUTTON_TOOLTIP: `Add feedback about a specific location`,
  OR: `or`,
