const en_US = {
  ...
  TOUR_DESK_STEP_5: `Use the Data Controls panel to customize which geographic regions are displayed on the map, along with the active metric.`,
  TOUR_DESK_STEP_6: `Use these buttons to switch between different types of regions.`,
